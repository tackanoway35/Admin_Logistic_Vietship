...
<script>
    ...
    function tinhtientudong(index)
    {
        ...
        .done((response) => {
            ...
            var errorElement = $('#wrapper'+index+'-coupon').find('.help-block-error');
            if(couponMessage)
            {
    ...
    $('.pho-giao-hang').change((e) => {
        ...
        {
            console.log("Chưa có gói dịch vụ hoặc nơi lấy hàng");
        }
    })
    ...
    $('.goi-dich-vu').change((e) => {
        ...
        {
            console.log("Chưa có nơi lấy hàng hoặc giao hàng");
        }
        tinhtientudong(index);
